...
import ensa.socialsphere.domain.models.viewModels.logger.LoggerViewModel;
...
public class LoggerControllerTests {
    ...
    @MockBean
    private LoggerService mocensaoggerService;
    ...
    public void allLogs_when2Logs_2Logs() throws Exception {
        ...
        when(this.mocensaoggerService.getAllLogs())
        ...
        verify(this.mocensaoggerService, times(1)).getAllLogs();
        verifyNoMoreInteractions(this.mocensaoggerService);
    }
    ...
    public void getLogsByUsername_whenUserHas2Logs_2Logs() throws Exception {
        ...
        when(this.mocensaoggerService.getLogsByUsername(anyString()))
                .thenReturn(loggerServiceModels);
        ...
        verify(this.mocensaoggerService, times(1)).getLogsByUsername(anyString());
        verifyNoMoreInteractions(this.mocensaoggerService);
    }
    ...
    public void deleteLogs_whenDeleteAllReturnsTrue_deleteLogs() throws Exception {
        when(mocensaoggerService.deleteAll())
                .thenReturn(true);
        ...
        verify(this.mocensaoggerService, times(1)).deleteAll();
        verifyNoMoreInteractions(this.mocensaoggerService);
    }
    ...
    public void deleteLogsByName_whenDeleteByNameReturnsTrue_deleteLogs() throws Exception {
        when(mocensaoggerService.deleteByName(anyString()))
                .thenReturn(true);
        ...
        verify(this.mocensaoggerService, times(1)).deleteByName(anyString());
        verifyNoMoreInteractions(this.mocensaoggerService);
    }
